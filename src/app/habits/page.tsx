  ...
  return (
    <div className="flex h-screen flex-col bg-lofi-dark/95">
      <header className="flex shrink-0 items-center gap-4 border-b border-lofi-brown/30 px-6 py-4">
        ...
        <h1 className="text-lg font-medium text-lofi-cream">习惯</h1>
      </header>
      <div className="flex flex-1 flex-col gap-4 overflow-auto p-6">
            ...
            >
              <button
                ...
                style={{
                  ...
                  backgroundColor: isChecked(habit.id, today)
                    ? habit.color
                    : "transparent",
                }}
              >
        ...
        {habits.length === 0 && (
          <p className="py-8 text-center text-lofi-cream/50">暂无习惯，添加一个开始打卡吧</p>
        )}
      </div>
    </div>
  );
